...
export { SimpleSearchState, SimpleDocumentInfo, SimpleOutlineNode, SimpleProgressData, SimplePDFBookmark } from './libs/simple-pdf-viewer/src/simplePdfViewer.models';
